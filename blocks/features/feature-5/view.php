...
<section id="<?php echo $id;?>" class="uk-position-relative features features-5 uk-padding-small" data-src="<?php echo $styles['bg_image']; ?>" uk-img>
		...
		<div class="uk-container">
			<div class="uk-div uk-position-relative">
				...
				<?php foreach($contents['items'] as $feature): ?>
				    <div class="card-single" <?php echo ($settings['items_animation'])? $items_animation . ';delay:' .'300"' : '' ;?>>
				        <div class="uk-card uk-card-hover uk-card-body">
							<div class="uk-grid-small uk-flex-middle uk-grid" uk-grid="">
							    ...
							    <div class="uk-width-expand uk-padding uk-padding-remove-top uk-padding-remove-bottom uk-padding-remove-right">
