...
#<?php echo $id; ?> .op-button-right{
	font-size : <?php echo $settings['button_font_size']; ?>px;
	background: transparent;
	border: 1px solid <?php echo $styles['button_text_color_right']; ?>;
	color : <?php echo $styles['button_text_color_right']; ?>;
	text-transform:<?php echo $settings['button_transformation']; ?>
}
#<?php echo $id; ?> .op-button-right:hover{
	background : <?php echo $styles['button_text_color_right']; ?>;
	color : <?php echo $styles['button_bg_color']; ?>;
	border-color : <?php echo $styles['button_text_color_right']; ?>;
}
