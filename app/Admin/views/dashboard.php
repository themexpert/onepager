...
<div class="wrap" uk-filter="target: .layout-filter">
	<h1 class="uk-title"><?php esc_html_e('Dashboard', 'tx-onepager');?>
	</h1>

	<?php if (!did_action('onepager_pro_loaded')) : ?>
	<div
		class="uk-card uk-card-small uk-card-secondary uk-card-body uk-margin uk-margin-medium-top uk-margin-medium-bottom">
		<div class="uk-grid uk-grid-small uk-flex-middle">
			<div class="uk-width-2-3">
				<div class="uk-grid uk-grid-small">
					<div class="uk-width-1-6 uk-first-column">
						<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px" height="40px"
							viewBox="251 356 110 80" enable-background="new 251 356 110 80" xml:space="preserve"
							fill="#fff">
							<g>
								<path
									d="M291.9,433.6l-25.1-67.7c0.3-2.5,2.4-3,4.6-3.1c2.2-0.2,49-1.3,49-1.3c5,0,6.2,1.3,7.5,3.3c1.3,2,17.8,30.6,17.8,30.6
			...
			<div class="uk-width-1-3">
				<a href="https://themesgrove.com/wp-onepager/?utm_source=wp-admin&utm_medium=dashboard&utm_campaign=wponepager-gopro"
					target="_blank" class="uk-button uk-button-danger"><?php esc_html_e('Explore Onepager Pro', 'tx-onepager');?></a>
			</div>
		</div>
	</div>
	<?php endif; ?>
	...
	<ul class="uk-subnav uk-subnav-pill" uk-margin>
		<li class="uk-active" uk-filter-control><a href="#"><?php esc_html_e('All', 'tx-onepager');?></a>
		</li>
		<?php foreach ($groups as $group) : ?>
		<li
			uk-filter-control="[data-group*='<?php echo sanitize_title($group); ?>']">
			<a href="#"><?php echo $group; ?></a></li>
		<?php endforeach; ?>
	</ul>
	...
	<div class="layout-filter uk-child-width-1-2@s uk-child-width-1-4@m" uk-grid>
		...
		<div
			data-group="<?php echo op_get_html_group_class($layout['group']); ?>">
			<div class="uk-card uk-card-default uk-transition-toggle" tabindex="0">
				<div class="uk-card-media-top uk-inline uk-height-medium" uk-overflow-auto>
					<img data-src="<?php echo $layout['screenshot']; ?>"
						alt="<?php echo $layout['name']; ?>"
						uk-img>
				</div>
				<div class="uk-card-footer uk-padding-small uk-margin-remove uk-text-center">
					<p class="uk-margin-small-bottom"><strong><?php echo $layout['name']; ?></strong>
					</p>
					<button id="layout-import" class="uk-button uk-button-primary uk-width-1-1"
	...
	<div id="layout-selection-modal" class="uk-flex-top" uk-modal="bg-close:false">
		<div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
			<h4 class="uk-modal-title"><?php esc_html_e('Get started with ', 'tx-onepager');?>
				<strong class="uk-text-primary"></strong></h4>
			<div uk-grid>
				...
				<div class="uk-width-2-3@m">
					<form class="uk-form-stacked" method="post" action="options.php">
						<div class="uk-margin">
							<label class="uk-form-label" for="form-stacked-text"><?php esc_html_e('Page Title', 'tx-onepager');?></label>
							<div class="uk-form-controls">
								<input require class="uk-input page-title" id="form-stacked-text" type="text"
									placeholder="<?php esc_html_e('Name of your page', 'tx-onepager');?>"
									required>
							</div>
						</div>
						<div class="uk-margin">
...
<script>
	...
	UIkit.util.on('#op_create_page_from_layout_button', 'click', function(e) {
		...
		if (!pageTitle) {
			alert("<?php esc_html_e('Please give a title for your page', 'tx-onepager');?>")
			return;
		}
